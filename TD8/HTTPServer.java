...
public class HTTPServer extends Server {
	 ...
	 * @param request La requête du client.
	 */
	private void replyData(Request request) throws IOException {
		// Ressource non déplacée.
		...
		// Ressource de type fichier trouvée.
	 ...
	 * @param request La requête du client.
	 */
	private void replyRequest(Request request) throws IOException {
		// En-tête de la réponse.
		replyHeader(request);
